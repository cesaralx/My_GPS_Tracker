...
<head>
<meta charset=utf-8>
<title>¡Seguimiento en directo TIVOLI Pizza!</title>

<!-- Open layer es un proveedor gratuito de servicios de mapeo -->
...
<script>
	...
	function initalizeMap() {
		...
		var goal  = new OpenLayers.Icon('img/chequered_flag.png',size2,offset);
    var icon  = new OpenLayers.Icon('img/marker1.png',size2,offset);
		var icon2 = new OpenLayers.Icon('img/marker2.png',size2,offset);
		var icon3 = new OpenLayers.Icon('img/marker3.png',size2,offset);
		var icon4 = new OpenLayers.Icon('img/marker4.png',size2,offset);
		var icon5 = new OpenLayers.Icon('img/marker5.png',size2,offset);
		var icon6 = new OpenLayers.Icon('img/marker6.png',size2,offset);
		var icon7 = new OpenLayers.Icon('img/marker7.png',size2,offset);
		...
		team3Popup = new OpenLayers.Popup("Repartidor3",
						team3LonLat,
						new OpenLayers.Size(145,52),
		...
		team4Popup = new OpenLayers.Popup("Repartidor4",
						team4LonLat,
						new OpenLayers.Size(145,52),
		...
		team5Popup = new OpenLayers.Popup("Repartidor5",
		...
		team6Popup = new OpenLayers.Popup("Repartidor6",
		...
		team7Popup = new OpenLayers.Popup("Repartidor7",
	...
	function updateMarkers(){
		...
		team1Popup.setContentHTML("<font size=-2>Repartidor 1<br>Lon: "+Math.round(team1Data[1] * 10000) / 10000+", Lat: "+Math.round(team1Data[0] * 10000) / 10000);
		...
		team2Popup.setContentHTML("<font size=-2>Repartidor 2<br>Lon: "+Math.round(team2Data[1] * 10000) / 10000+", Lat: "+Math.round(team2Data[0] * 10000) / 10000);
		...
		team3Popup.setContentHTML("<font size=-2>Repartidor 3<br>Lon: "+Math.round(team3Data[1] * 10000) / 10000+", Lat: "+Math.round(team3Data[0] * 10000) / 10000);
		...
		team4Popup.setContentHTML("<font size=-2>Repartidor 4<br>Lon: "+Math.round(team4Data[1] * 10000) / 10000+", Lat: "+Math.round(team4Data[0] * 10000) / 10000);
		...
		team5Popup.setContentHTML("<font size=-2>Repartidor 5<br>Lon: "+Math.round(team5Data[1] * 10000) / 10000+", Lat: "+Math.round(team5Data[0] * 10000) / 10000);
		...
		team6Popup.setContentHTML("<font size=-2>Repartidor 6<br>Lon: "+Math.round(team6Data[1] * 10000) / 10000+", Lat: "+Math.round(team6Data[0] * 10000) / 10000);
		...
		team7Popup.setContentHTML("<font size=-2>Repartidor 7<br>Lon: "+Math.round(team7Data[1] * 10000) / 10000+", Lat: "+Math.round(team7Data[0] * 10000) / 10000);
	}
</script>
</head>
